...
public:
	...
	*/
	...
	virtual void update(int id, GLfloat* data) const;
	virtual void updateV(int id, GLsizei count, GLfloat* data) const;

	virtual void update1f(int id, GLfloat val0) const;
	virtual void update2f(int id, GLfloat val0, GLfloat val1) const;
	virtual void update3f(int id, GLfloat val0, GLfloat val1, GLfloat val2) const;
	virtual void update4f(int id, GLfloat val0, GLfloat val1, GLfloat val2, GLfloat val3) const;

	virtual void update1i(int id, GLint val) const;
